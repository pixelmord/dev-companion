...
import { PlusCircle, X, Code, Paperclip, Send } from 'lucide-react';
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
          ...
          {showCodeEditor && (
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <h3 className="text-neon-cyan text-sm font-pixel">Code Snippet</h3>
          ...
          {showAttachments && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h3 className="text-neon-cyan text-sm font-pixel mb-2">Attach Resource</h3>
                <select 
              ...
              <div>
                <h3 className="text-neon-cyan text-sm font-pixel mb-2">Attach Project</h3>
                <select 
          ...
          <div className="flex items-center justify-between pt-2 border-t border-retro-light">
            ...
            <Button type="submit" className="bg-neon-cyan text-retro-dark hover:bg-neon-cyan/90">
