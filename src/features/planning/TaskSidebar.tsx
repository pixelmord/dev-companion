...
const TaskSidebar: React.FC<TaskSidebarProps> = ({ tasks }) => {
  ...
  return (
    <ResizablePanelGroup direction="horizontal">
      <ResizablePanel defaultSize={20} minSize={15} maxSize={25} className="bg-retro-medium border-l border-retro-light h-full">
          ...
          <div className="flex gap-2 mb-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon" className="bg-retro-dark border-retro-light hover:bg-retro-light">
                  <Filter size={16} />
                </Button>
              </DropdownMenuTrigger>
